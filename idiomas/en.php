...
'Ya tienes esta clase reservada todos los %s a las %s.' => 'You already have this class booked every %s at %s.',
'Gestionar mis clases recurrentes' => 'Manage my recurring classes',
'Reservar esta clase y repetirla cada semana, el mismo día y hora, mientras tenga cupo y mi paquete esté activo.' => 'Book this class and repeat it every week, on the same day and time, while there is availability and my package is active.',
...
'y confirmar' => 'and confirm',
'Número de plazas' => 'Number of spots',
'El descuento solo se aplica a la primera plaza; el resto se paga al precio completo.' => 'The discount only applies to the first spot; the rest are paid at full price.',
...
'Pendiente de paquete' => 'Pending package',
'Se confirmará automáticamente cuando actives un paquete con usos disponibles.' => 'It will be confirmed automatically once you activate a package with uses available.',
'Además reservamos %d clases futuras del mismo horario. %d quedaron pendientes de que actives un paquete con usos disponibles.' => 'We also booked %d future classes at the same time. %d are pending until you activate a package with uses available.',
'Clases recurrentes' => 'Recurring classes',
'No tienes ninguna clase reservada de forma recurrente.' => 'You don\'t have any classes booked recurringly.',
...
'Ropa de yoga estilizada' => 'Stylized yoga clothing',
'Todavía no hay productos disponibles en la tienda.' => 'There are no products available in the shop yet.',
'Comprar' => 'Buy',
'El producto no existe o no está disponible.' => 'The product does not exist or is not available.',
'Volver a la tienda' => 'Back to the shop',
'Tallas disponibles:' => 'Available sizes:',
'También te puede interesar' => 'You may also like',
'Volver al producto' => 'Back to the product',
'Talla' => 'Size',
'Selecciona una talla' => 'Select a size',
'El producto solicitado no existe.' => 'The requested product does not exist.',
'Mis compras' => 'My purchases',
'Producto comprado correctamente. Nos pondremos en contacto para coordinar la entrega.' => 'Product purchased successfully. We will contact you to arrange delivery.',
'Ir a la tienda' => 'Go to the shop',
'Todavía no tienes ninguna compra.' => 'You don\'t have any purchases yet.',
'Talla:' => 'Size:',
...
'Pagar' => 'Pay',
'Formulario de inscripción | Sama Shala' => 'Registration form | Sama Shala',
'Formulario de inscripción' => 'Registration form',
'Completa tus datos de salud y la autorización para poder practicar en Sama Shala.' => 'Complete your health details and authorization to be able to practice at Sama Shala.',
'Tus datos se han guardado correctamente.' => 'Your details have been saved successfully.',
'Nombre completo' => 'Full name',
'Celular / Teléfono' => 'Cell phone / Phone number',
'Fecha de nacimiento' => 'Date of birth',
'¿Has practicado yoga o meditación antes?' => 'Have you practiced yoga or meditation before?',
'Sí' => 'Yes',
'No' => 'No',
'¿Tienes alguna lesión, dolor o condición física que debamos conocer?' => 'Do you have any injury, pain, or physical condition we should know about?',
'Cuéntanos más sobre tu lesión, dolor o condición física' => 'Tell us more about your injury, pain, or physical condition',
'¿Has tenido alguna cirugía o condición médica relevante?' => 'Have you had any surgery or relevant medical condition?',
'Cuéntanos más sobre esa cirugía o condición médica' => 'Tell us more about that surgery or medical condition',
'¿Cuáles son tus hobbies o intereses?' => 'What are your hobbies or interests?',
'De conformidad con la Ley Orgánica de Protección de Datos Personales, autorizo el uso de mis datos para registro, acompañamiento en la práctica y comunicación interna. También autorizo el uso de mi imagen (fotos o vídeos) para compartir en los medios de Sama Shala.' => 'In accordance with the Organic Law on Personal Data Protection, I authorize the use of my personal data for registration, guidance during the practice, and internal communication. I also authorize the use of my image, including photos or videos, to be shared on Sama Shala\'s media channels.',
...
'Cooperativa JEP' => 'JEP Cooperative',
'Banco Pichincha' => 'Pichincha Bank',
...
'Foto del comprobante de la transferencia' => 'Photo of the transfer receipt',
'Tu compra quedará pendiente de revisión hasta que confirmemos el pago.' => 'Your purchase will remain pending review until we confirm the payment.',
'Tu reserva quedará pendiente de revisión hasta que confirmemos el pago.' => 'Your booking will remain pending review until we confirm the payment.',
'Hemos registrado tu compra por transferencia bancaria. Quedará pendiente de revisión hasta que confirmemos el pago.' => 'We have registered your purchase by bank transfer. It will remain pending review until we confirm the payment.',
'Hemos registrado tu reserva por transferencia bancaria. Quedará pendiente de revisión hasta que confirmemos el pago.' => 'We have registered your booking by bank transfer. It will remain pending review until we confirm the payment.',
